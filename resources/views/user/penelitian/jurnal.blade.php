                    ...
                    <div class="row g-5">
                        <div class="col-md-6 px-5">
                            <div class="trend-bottom-img mb-10" style="height: 225px;">
                                <img class="card-img rounded-0" src="{{ url ('storage/featured_images/'.$data->post_featured_image) }}" alt="featured-image" href="{{ url('/'.$postUrl->post_categories_url.'/'.$data->post_link) }}">
