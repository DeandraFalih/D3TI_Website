                        ...
                        <div class="weekly2-news-active dot-style d-flex dot-style">
                            ...
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <a href="{{ url('/'.$postUrl->post_categories_url.'/'.$data->post_link) }}"><img src="{{ url ('storage/featured_images/'."(thumbnail)".$data->post_featured_image) }}" alt="featured-image" style="height: 170px; object-fit: cover;"></a>
                                </div>
                                <div class="weekly2-caption">
                                    ...
                                    <h4><a href="{{ url('/'.$postUrl->post_categories_url.'/'.$data->post_link) }}">{{ $data->post_title }}</a></h4>
                                </div>
                            </div> 
                            @endforeach
                        </div>
                    ...
                    <div class="col-12">
                        <div class="weekly2-news-active dot-style d-flex dot-style">
                            ...
                            @php
                                ...
                                $eventUrl = getSelectedEventUrl($data->event_id);
                                $eventtUrl = $eventUrl->first();
                            @endphp
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <a href="{{ url('/'.$postUrl->post_categories_url.'/'.$data->post_link) }}"><img src="{{ url ('storage/featured_images/'."(thumbnail)".$data->event_featured_image) }}" alt="featured-image" style="height: 170px; object-fit: cover;"></a>
                                </div>
                                <div class="weekly2-caption">
                                    <ul class="blog-info-link mt-1 mb-1">
                                    ...
                                    <h4><a href="{{ url('/'.$eventUrl->event_categories_url.'/'.$data->event_link) }}">{{ $data->event_title }}</a></h4>
                                </div>
                            </div> 
                            @endforeach
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="weekly2-news-active dot-style d-flex dot-style" id="mitra-kerjasama-slider">
                            <div class="weekly2-single">
                                <div class="weekly2-img">
                                    <img src="{{ url ('user/img/redhat.jpg') }}" alt="featured-image" style="height: 136px;">
                                </div>
                            </div> 
                            <div class="weekly2-single">
                                <div class="weekly2-img">
