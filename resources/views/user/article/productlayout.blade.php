                    ...
                    <div class="col-lg-8 posts-list">
                       <div class="single-post">
                          ...
                          <div class="feature-img">
                             <img class="img-fluid w-100" src="{{ url('user/img/valo.png') }}" style="object-fit: cover;">
                          </div>      
                          <div class="blog_details">
                           ...
                           <br>
                          <div>
                              <h5 class="text-product">Product Owner :</h5>
                              <h6 class="text-product">Unknown</h6>
                              <br>
                              <h5 class="text-product">Link Product : </h5>
                          </div>
                          <div class="text-product">
                              <a href="http://youtube.com">
                                 <img class="button-product" src=" {{ url ('user/img/button.png')}}">
                              </a>
                          </div>
                          <br>
                          <br>
