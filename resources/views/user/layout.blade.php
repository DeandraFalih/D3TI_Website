                                ...
                                <div class="main-menu d-none d-md-block">
                                    <nav class="d-flex flex-row-reverse">            
                                        <ul id="navigation">
                                            ...
                                            <li class="li-mb"><a class="submenu-text-color" href="{{ url('/penelitian-dosen-news') }}">Mahasiswa</a></li>
                                            ...
                                            <li class="li-mb"><a class="submenu-text-color" href="#">Penelitian</a>
                                                <ul class="submenu submenu-line-height">
                                                    ...
                                                    <li><a href="{{ url('/p/category/kemahasiswaan') }}">Pengabdian</a></li>
                                                    <li><a href="{{ url('/penelitian-pengabdian') }}">Kerjasama</a></li>
                                                </ul>
                                            </li>
                                            <li class="li-mb"><a class="submenu-text-color" href="{{ url('/pr/category/ta') }}">Contact</a></li>
                                            <li class="li-mb">
                                                <ul class="header-right-btn f-right d-none d-lg-block">
